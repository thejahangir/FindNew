...
export default function ForgotPasswordForm({ setView }) {
 ...
 <button
 type="submit"
 className="w-full flex items-center justify-center gap-2 bg-brand-dark text-white py-2.5 rounded-xl text-sm font-medium hover:bg-gray-800 transition-all hover:shadow-lg hover:shadow-brand-dark/30 active:scale-[0.98]"
 >
 Send Reset Link
 <ArrowRight size={16} />
 </button>
